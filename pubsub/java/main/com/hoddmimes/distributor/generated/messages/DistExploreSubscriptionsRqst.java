...
public class DistExploreSubscriptionsRqst implements MessageInterface   
{
    public static final int MESSAGE_ID = ((1 << 16) + 14);
...
public DistExploreSubscriptionsRqst()
{
 
}


public  DistExploreSubscriptionsRqst(byte[]  pMessageByteArray ) {
...
public String getMessageName() {
   return "DistExploreSubscriptionsRqst";
}

public String getFullMessageName() {
    return "com.hoddmimes.distributor.generated.messages.DistExploreSubscriptionsRqst";
}
...
public String toString( int pCount, boolean pExtention ) {
    ...
    if (pExtention)  {
    	tSB.append("<Extending Message: " + "\"DistExploreSubscriptionsRqst\"  Id: " + Integer.toHexString(getMessageId()) + ">\n");
    } else {
    		tSB.append("Message: " + "\"DistExploreSubscriptionsRqst\"  Id: " +  Integer.toHexString(getMessageId())  + "\n");
    }
	...
	treeNode = new TreeNode("DistExploreSubscriptionsRqst");
	} else {
	treeNode =  new TreeNode( pMessageAttributeName  + " [DistExploreSubscriptionsRqst]");
	}
