 ...
 * 
 */
public class BdxGwyClient implements TcpIpConnectionCallbackInterface {
	...
	public BdxGwyClient(String pHostAddress, int pHostPort) {
	...
	class ConnectionThread extends Thread {
		...
		public void run() {
			try {
				TcpIpConnection tConn = TcpIpClient.connect(TcpIpConnectionTypes.Compression, mHostAddress, mHostPort, BdxGwyClient.this);
				synchronized (mConnectionThread) {
					mConnectionThread.set(null);
					synchronized (BdxGwyClient.this) {
						mConnection = tConn;
						resendSubjectNames();
					}
