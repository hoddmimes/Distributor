...
public class DistTriggerCofigurationRqst implements MessageInterface   
{
...
public DistTriggerCofigurationRqst()
{
 
}


public  DistTriggerCofigurationRqst(byte[]  pMessageByteArray ) {
...
public String getMessageName() {
   return "DistTriggerCofigurationRqst";
}

public String getFullMessageName() {
    return "com.hoddmimes.distributor.generated.messages.DistTriggerCofigurationRqst";
}
...
public String toString( int pCount, boolean pExtention ) {
    ...
    if (pExtention)  {
    	tSB.append("<Extending Message: " + "\"DistTriggerCofigurationRqst\"  Id: " + Integer.toHexString(getMessageId()) + ">\n");
    } else {
    		tSB.append("Message: " + "\"DistTriggerCofigurationRqst\"  Id: " +  Integer.toHexString(getMessageId())  + "\n");
    }
	...
	treeNode = new TreeNode("DistTriggerCofigurationRqst");
	} else {
	treeNode =  new TreeNode( pMessageAttributeName  + " [DistTriggerCofigurationRqst]");
	}
