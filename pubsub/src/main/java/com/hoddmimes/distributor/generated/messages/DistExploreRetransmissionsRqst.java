...
public class DistExploreRetransmissionsRqst implements MessageInterface   
{
    public static final int MESSAGE_ID = ((1 << 16) + 16);
...
public DistExploreRetransmissionsRqst()
{
 
}


public  DistExploreRetransmissionsRqst(byte[]  pMessageByteArray ) {
...
public String getMessageName() {
   return "DistExploreRetransmissionsRqst";
}

public String getFullMessageName() {
    return "com.hoddmimes.distributor.generated.messages.DistExploreRetransmissionsRqst";
}
...
public String toString( int pCount, boolean pExtention ) {
    ...
    if (pExtention)  {
    	tSB.append("<Extending Message: " + "\"DistExploreRetransmissionsRqst\"  Id: " + Integer.toHexString(getMessageId()) + ">\n");
    } else {
    		tSB.append("Message: " + "\"DistExploreRetransmissionsRqst\"  Id: " +  Integer.toHexString(getMessageId())  + "\n");
    }
	...
	treeNode = new TreeNode("DistExploreRetransmissionsRqst");
	} else {
	treeNode =  new TreeNode( pMessageAttributeName  + " [DistExploreRetransmissionsRqst]");
	}
