...
public DistBdxGwyPingRqst()
{
 
}


public  DistBdxGwyPingRqst(byte[]  pMessageByteArray ) {
...
public String getMessageName() {
   return "DistBdxGwyPingRqst";
}

public String getFullMessageName() {
    return "com.hoddmimes.distributor.generated.messages.DistBdxGwyPingRqst";
}
...
public String toString( int pCount, boolean pExtention ) {
    ...
    if (pExtention)  {
    	tSB.append("<Extending Message: " + "\"DistBdxGwyPingRqst\"  Id: " + Integer.toHexString(getMessageId()) + ">\n");
    } else {
    		tSB.append("Message: " + "\"DistBdxGwyPingRqst\"  Id: " +  Integer.toHexString(getMessageId())  + "\n");
    }
	...
	treeNode = new TreeNode("DistBdxGwyPingRqst");
	} else {
	treeNode =  new TreeNode( pMessageAttributeName  + " [DistBdxGwyPingRqst]");
	}
